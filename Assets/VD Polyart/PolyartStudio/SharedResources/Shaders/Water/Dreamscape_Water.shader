	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord66 = IN.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord91 = IN.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float2 panner93 = ( 1.0 * _Time.y * float2( 0.07,0.07 ) + texCoord91);
				float2 temp_cast_4 = (_WaveTiling02).xx;
				float2 texCoord105 = IN.ase_texcoord7.xy * temp_cast_4 + float2( 0,0 );
				float2 panner106 = ( 1.0 * _Time.y * float2( -0.07,-0.07 ) + texCoord105);
				...
				float2 temp_cast_5 = (_FoamSpeed).xx;
				float2 temp_cast_6 = (_FoamScale).xx;
				float2 texCoord5 = IN.ase_texcoord7.xy * temp_cast_6 + float2( 0,0 );
				float2 panner8 = ( mulTime7 * temp_cast_5 + texCoord5);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner93 = ( 1.0 * _Time.y * float2( 0.07,0.07 ) + texCoord91);
				float2 temp_cast_4 = (_WaveTiling02).xx;
				float2 texCoord105 = IN.ase_texcoord3.xy * temp_cast_4 + float2( 0,0 );
				float2 panner106 = ( 1.0 * _Time.y * float2( -0.07,-0.07 ) + texCoord105);
				float vDisplacement123 = ( saturate( ( tex2D( _Displacement, panner93 ).r + tex2D( _Displacement, panner106 ).r ) ) * _DisplaceStrength );
				float4 lerpResult102 = lerp( lerpResult22 , ( lerpResult22 + float4( 0.5,0.5,0.5,0 ) ) , vDisplacement123);
				float4 vColorWaves122 = lerpResult102;
				...
				float2 temp_cast_5 = (_FoamSpeed).xx;
				float2 temp_cast_6 = (_FoamScale).xx;
				float2 texCoord5 = IN.ase_texcoord3.xy * temp_cast_6 + float2( 0,0 );
				float2 panner8 = ( mulTime7 * temp_cast_5 + texCoord5);
				float simpleNoise13 = SimpleNoise( panner8*50.0 );
				float height107_g2 = simpleNoise13;
				float scale107_g2 = 2.0;
...
/*ASEBEGIN
Version=18935
644;73;2475;1091;2863.612;1358.352;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;29;-1271.5,-1087.091;Inherit;False;DepthMaskedRefraction;-1;;3;c805f061214177c42bca056464193f81;2,40,0,103,0;2;35;FLOAT3;0,0,0;False;37;FLOAT;0.02;False;1;FLOAT2;38
...
ASEEND*/
//CHKSM=2CDB026F99D87ABE6097EADBA12EAB936A243DC3